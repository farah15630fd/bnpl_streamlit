...
if choix == "Accueil":
    ...
    if st.session_state.carte_achetee != "aucune":
        ...
        st.warning("Aucune donnée de paiement disponible tant qu'une carte n'est pas activée.")
...
# HISTORIQUE DE PAIEMENT
    ...
    if st.session_state.carte_achetee != "aucune":
        ...
        st.write("- 15/05/2025 — 240 DT — Batam")
        st.write("- 10/05/2025 — 110 DT — MG")
        st.subheader("Paiements en ligne")
        st.write("- 08/05/2025 — 70 DT — Monoprix")
        st.write("- 01/05/2025 — 50 DT — Fatal")
    else:
